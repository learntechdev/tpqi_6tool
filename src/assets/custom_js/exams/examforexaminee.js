...
function printDocs1(template_id, tool_type, tpqi_exam_no, doc_type) {
...
function printDocs(template_id, tool_type, template_type, doc_type) {
	if (tool_type == "3" || tool_type == "4" || tool_type == "5") {
		printHTML(template_id, tool_type, doc_type);
	} else {
		sweet_alert(
			"<strong>เครื่องมือประเมินนี้ ไม่อนุญาตให้นำข้อสอบไปใช้!!!</strong>"
		);
