   ...
   <section id="requiredprinting">
    <div class="container">
	 <div class="row mt-3" id="nonPrint">
        ...
        <table border="1" style="border-collapse: collapse;overflow:wrap;" autosize="1">
            <thead>
                <tr style="background:#CFCFCF">
                    <th width="40%" style="text-align:center;font-weight:bold">คำถาม do
                    </th>
            ...
            <tbody>
                ...
                <tr>
                    <td class="v-top" style="vertical-align: text-top;">
