    ...
    <table class="table text-nowrap table-bordered">
        <thead class="bg-primary">
            <tr>
                ...
                <th class="text-center" style="width: 8%;font-weight:bold;">รอบสอบ</th>
                <th class="text-center" style="width: 42%;font-weight:bold;">ชื่อองค์กรรับรอง/คุณวุฒิวิชาชีพ</th>
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <?php
                            ...
                            if ($isdocs_exam != 0) { ?>
                   <br><button type="button" class="btn btn-primary btn-sm" onclick="show_docsexam(<?= $v['exam_template_id'] ?>)">
                        
                        <i class="fa fa-files-o" aria-hidden="true"></i> เอกสารเพิ่มเติม</button>
                    <?php }
                            ?>
                </td>
            </tr>
