        ...
        <div class="col-md-12">
            <div class="card" style="min-height:480px">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <span class="label_head">สร้างข้อสอบ สังเกตการณ์ในหน้างานจริง</span>
                            <hr />
                        </div>
                        ...
                        <div class="col-md-12">
                            <form id="form" name="form">
                                ...
                                <hr />
                                <div class="col-md-12">
                                    <div id="div_checklist_single">
                                        <div id="uoc" style="display:none">
                                            <br />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row" style="text-align:center;display:none; " id="operation">
                                        ...
                                        <div class="" style="padding:5px" id="div_sendapprove">
                                            ...
                                            &nbsp;
                                            <a href="../../exam_library/Examlibrary/index?tool_type=6&contract_no=<?= $strContractNo ?>"
...
<script type="text/javascript" src="<?= base_url(); ?>assets/custom_js/observation/form.js?<?= date("YmdHis") ?>">
</script>