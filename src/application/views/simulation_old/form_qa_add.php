...
?>
    <input type="hidden" id="last_idx" name="last_idx" value="<?=$i?>">
    <div id="form_q_a">
        <div id="f<?=$i?>">
            <div class="card">
                ...
                <div class="card-body row">
                    <div class="col-md-6">
                        <label for=""><strong>คำถาม ข้อที่ 1.<span id="q_num"></span></strong></label>
                        <textarea id="list[<?=$i?>][question]" name="list[<?=$i?>][question]"></textarea>
                    </div>
                    <div class=" col-md-6">
                        <label for=""><strong>เฉลย</strong></label>
                        <textarea id="list[<?=$i?>][answer]" name="list[<?=$i?>][answer]"></textarea>
                    </div>
                </div>
            </div>
        </div>
