        ...
        <div class="col-md-12">
            <div class="card" style="min-height:480px">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <span class="label_head">แสดงข้อมูลผู้ใช้งาน</span>
                        </div>
                        <div class="col-md-6 text-right">
                            <button class="btn btn-dark" id="btn_add" name="btn_add"><i class="fa fa-plus-circle" aria-hidden="true"></i>
                    ...
                    <div class=" row" id="show_data">
                        <?php
                        if (!empty($dataList)) {
                            $this->load->view("settings/user_role/showdata", array(
                                "dataList" => $dataList,
                            ));
                        } else { ?>
                    </div>
...
<script type="text/javascript" src="<?= base_url(); ?>assets/custom_js/setting/user_role.js?<?= date("YmdHis") ?>">
</script>