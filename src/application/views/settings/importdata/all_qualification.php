    ...
    <div class="col-md-8">
        <form>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" id="api_url" value="https://tpqinet-api.tpqi.go.th/web_api/v1/all_qualification">
                </div>
            </div>
            <div class="row">
...
<script type="text/javascript" src="<?= base_url(); ?>assets/custom_js/setting/import_all_qualification.js?<?= date("YmdHis") ?>">
</script>
