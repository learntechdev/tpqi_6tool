            ...
            <div class="card" style="min-height:480px">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <form method="post" id="form" name="form" enctype="application/json">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="">
                                            <?php
                                            ...
                                            <input type="hidden" class="form-control" id="tool_type" name="tool_type" value="3" />
                                ...
                                <div class="col-md-12">
                                    <br /><br /> <br /><br />
                                    <div class="d-flexs" style="text-align:center;display:inline; " id="div_manage">
