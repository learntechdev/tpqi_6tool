...
<div class="table-responsive">
    <table class="table text-nowrap table-bordered">
        <thead class="bg-primary">
            <tr>
                <th class="text-center" style="width: 5%;font-weight:bold;">id</th>
                <th class="text-center" style="width: 20%;font-weight:bold;">File Name</th>
                <th class="text-center" style="width: 50%;font-weight:bold;">Template Id</th>
                <th class="text-center" style="width: 10%;font-weight:bold;">Created Date</th>
            ...
            <tr>
                ...
                <td class="text-wrap tbl-td-content">
                    ...
                    <span style="font-weight:bold"><?php
                                                            echo $v->docs_filename ?></span>
                </td>
                <td class="text-center wrapword">
                    <?php echo $v->docs_template_id ?>
                </td>
