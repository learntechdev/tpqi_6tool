...
<div class="content-header">
    <h3> บันทึกผลการประเมิน (รายบุคคล) </h3>
    <ol class="breadcrumb">
    ...
    <div class="card" style="min-height:480px">
        <div class="card-body">
            <form id="form" name="form">
                ...
                <input type="hidden" id="occ_level_name" name="occ_level_name" value="<?= $_POST["occ_level_name"] ?>">
                <div>
                    <h3>
                ...
                <div class="row">
                    <?php
                    if ($v->criteria_used_byexamier == 0) {
                        //require_once dirname(__FILE__) . "../../../assessment_result/form_uoc_passornot.php";
                        $this->load->view("v2/assessment_result/interview/form_uoc_passornot");
                    } else {
                        $this->load->view("v2/assessment_result/interview/form_uoc");
                        // $this->load->view("interview/assessment/form_uoc");
                    }
                    ?>
                </div>
                <br />
...
<!--modal recorder-->
<div>
    <?php require_once dirname(__FILE__) . "../../../alert/modal_recorder.php"; ?>
    <?php require_once dirname(__FILE__) . "../../../alert/modal_upload.php"; ?>
</div>

<script type="text/javascript"
    src="<?= base_url(); ?>assets/custom_js/interview/assessment_form.js?<?= date("YmdHis") ?>">
</script>