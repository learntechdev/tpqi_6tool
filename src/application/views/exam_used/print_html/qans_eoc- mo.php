...
<body>
    <div class="container">
        <table width="100%">
            <tr>
                ...
                <td width="50%" style="text-align:right; vertical-align:middle;font-size:12px"> <button type="button"
    ...
    <div class="container">
        <div id="requiredprinting" style="font-size:12px">
            <table width="100%">
                <tr>
                    <td width="10%">
            ...
            <div style="page-break-before: always;"></div>
				<?php if (!empty($rs_detail)) { ?>
            <table border="1" width="1300px" style="border-collapse: collapse; table-layout: fixed; margin-left: auto; margin-right: auto;" id="content2">
                <thead>
                    <tr style="background:#CFCFCF">
                        <th rowspan="2" width="90%" style="text-align:center;font-weight:bold;word-wrap: break-word;">คำถาม</th>
                        <th colspan="2" style="width:10%;text-align:center;font-weight:bold;word-wrap: break-word;">คำตอบ</th>
                    </tr>
                    <tr style="background:#CFCFCF">
                        ...
                        <?php } else { ?>
                        <th style="width:5%;text-align:center;font-weight:bold;word-wrap: break-word;">ผ่าน
                        </th>
                        <th style="width:5%;text-align:center;font-weight:bold;word-wrap: break-word;">ไม่ผ่าน
                        </th>
                        <?php } ?>
                    </tr>
                </thead>
                ...
                <?php
                        if ($tmp_uoc_code != $v_detail->uoc_code) { ?>
                <tr>
                    <td colspan="3" style="background-color:#F1F1F1;word-wrap: break-word;">
                        <?php
                                    $rs = $this->SharedModel->get_uocname($v_detail->uoc_code)
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="3" style="font-style: italic;word-wrap: break-word;">
                            <?php
                    ...
                    <tr>
					 ...
					 <tr>
                        <td colspan="3" style="word-wrap: break-word;"><span><strong> ข้อคิดเห็น/ข้อเสนอแนะ </strong></span> <br/><br/><br/><br/><br/><br/>
						<br/><br/><br/><br/><br/><br/>
