...
<body >
    <div class="container">
        ...
        <div style="font-size:20px;font-weight:bold;text-align:center">
            <?php echo "ข้อสอบ" . $tool_typename; ?><br /><?php echo $occ_levelname; ?> <br />
            (ชุดคำตอบ)
        </div>
        <br />
        ...
        if (is_array($result)) {
            foreach ($result as $v) {
        ?>
        <div><strong>คำชี้แจงสำหรับผู้ประเมิน </strong></div>
        <div style="padding-left:10px"><?= $v->desc_for_examier ?></div>
        <?php if ($v->case_study != "" && $v->tool_type == "4") { ?>
        <div><strong>โจทย์สำหรับจำลองสถานการณ์ </strong></div>
        <div style="padding-left:10px"><?= $v->case_study ?></div>
        <?php } ?>
        <?php }
        } ?>
        ...
        <table border="1" width="100%" style="border-collapse: collapse;overflow:wrap;" autosize="1">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <?php echo $j . "." . $v_detail->question ?><br /><br />
