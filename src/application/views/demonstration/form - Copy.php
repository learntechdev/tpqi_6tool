        ...
        <div class="col-md-12">
            <div class="card" style="min-height:480px">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <span class="label_head">สร้างข้อสอบ สาธิตการปฏิบัติงาน</span>
                            <hr />
                        </div>
                        <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row" style="text-align:center;display:none; " id="operation">
                                        ...
                                        <div class="" style="padding:5px" id="div_sendapprove">
                                            ...
                                            <a href="../../exam_library/Examlibrary/index?tool_type=5&contract_no=<?= $strContractNo ?> "
...
<script type="text/javascript" src="<?= base_url(); ?>assets/custom_js/demonstration/form.js?<?= date("YmdHis") ?>">
</script>