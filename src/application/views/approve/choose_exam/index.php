                    ...
                    <div class="row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select style="height:40px" class="form-control " data-dropup-auto="false"
                                            ...
                                            <option value="3">กำหนดชุดข้อสอบ</option>

                                            <option value="1">ยังไม่กำหนดชุดข้อสอบ</option>
                        ...
                        <div class="col-md-12" id="show_data">
							...
							if (!empty($dataList)) {
								...
								$this->load->view("approve/choose_exam/showdata", array(
...
<script type="text/javascript" src="<?= base_url(); ?>assets/custom_js/approve/choose_exam.js?<?= date("YmdHis") ?>">
