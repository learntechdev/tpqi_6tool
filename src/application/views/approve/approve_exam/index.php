                ...
                <div class="card-body pb-0">
                    <div class="row">
                            ...
                            <div class="col-md-12 ">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select style="height:40px" class="form-control " data-dropup-auto="false"
                                            id="status" name="status" required="" data-live-search="true">
                                            <option value="0">--ทั้งหมด--</option>
                                            <option value="7">อนุมัติ</option>
                                            <option value="8">ไม่อนุมัติ</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-3" style="padding-top:20px">
                                        <div class="btn-group  btn-group-md" role="group">
                                            ...
                                            <button type="button" class="btn btn-info" id="btn_cleardata"
                                                name="btn_cleardata">
                        ...
                        <div class="col-md-12" id="show_data">
                            <?php
							if (!empty($dataList)) {
								$this->load->view("approve/approve_exam/showdata", array(
									"dataList" => $dataList,
								));
							} else { ?>
...
<script type="text/javascript" src="<?= base_url(); ?>assets/custom_js/approve/approve_exam.js?<?= date("YmdHis") ?>">
</script>