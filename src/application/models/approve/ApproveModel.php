...
class ApproveModel extends CI_Model
{
    ...
    public function get_review_exam($filter = array())
    {
        ...
        if ($_SESSION['user_type'] != '1') {
            ...
            $sql_occ_level_id = " SELECT GROUP_CONCAT(CONCAT('\'', occ_level_id	, '\'')) occ_level_id 
                                FROM user_access_occlevel 
                                WHERE username = '" . $citizenID . "' ";
            $rs_occ_level_id = $this->BaseModel->get_all_rowarr($sql_occ_level_id);
