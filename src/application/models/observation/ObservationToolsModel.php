...
class ObservationToolsModel extends CI_Model

{
...

    {
        ...
        if ($assessment_id != "") {
            ...
            for ($i = 0; $i < COUNT($detail_arr); $i++) {
                ...
                $rs = $this->db->insert('assessment_detail_observation', $assessment_detail_insert);
            }
...

    {
        ...
        for ($i = 0; $i < COUNT($data); $i++) {
            ...
            $rs = $this->BaseModel->insert("assessment_detail_observation_file", $arr_list);
        }
